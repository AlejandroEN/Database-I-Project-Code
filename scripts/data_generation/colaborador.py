...
def generate_colaborador_data(
    ...
    file, writer = setup_csv_writer(f"colaborador_{schema_size}.csv")
    ...
    for _ in range(rows_amount):
        ...
        sueldo_hora = faker.pyfloat(left_digits=3, right_digits=1, positive=True)
        cci = faker.numerify("####################")
        numero_celular = faker.phone_number()
        horas_semanales_trabajo = faker.numerify("%")
